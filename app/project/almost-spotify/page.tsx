    ...
    <>
      ...
      <div className='px-8 sm:px-16 pt-20'>
        <div className='max-w-screen-lg m-auto'>
          <h1 className='text-5xl font-medium mb-4'>Almost Spotify</h1>
          <p className='max-w-xl mb-2'>
            A responsive Spotify clone built with Next.js, TypeScript, and
            Tailwind CSS. It uses NextAuth for authentication, the Spotify API
            to fetch data about tracks, albums, playlists, and the currrent
            user, and the Spotify Web Playback SDK to control playback in the
            application. Users are required to log in with a Spotify Premium
            account.
          </p>
