...
const ProjectOverview = ({
  ...
  return (
    <div className='flex flex-col md:flex-row justify-between md:items-center w-full overflow-hidden'>
      ...
      <div className='flex flex-col gap-3 md:gap-8 md:pl-12 flex-1 mt-8 md:mt-0'>
        <div>
          <p className='text-sm md:text-base uppercase text-neutral'>
            {subtitle}
          </p>
          <h3 className='text-2xl md:text-3xl font-semibold mt-1 md:mt-4'>
            {title}
          </h3>
        </div>
        <p>{description}</p>
